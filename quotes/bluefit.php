...
try {
    ...
    // Track page view
    $stmt = $pdo->prepare("INSERT INTO quote_views (quote_id, session_id, visitor_ip, user_agent, referrer, country, region, city, timezone, view_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$quote_id, $session_id, $visitor_ip, $user_agent, $referrer, $country, $region, $city, $timezone, $visit_time]);
...
<body>
  ...
  <img src="img/on+av_logo_v2.png" alt="On+Av Logo" style="max-width:180px; max-height:60px; display:block;">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;" class="price">R$ 10.000,00</td>
                            <td style="text-align: right;" class="price">R$ 10.000,00</td>
                        </tr>
                        <tr>
                            <td>Equipe especializada Disguise</td>
                            <td style="text-align: center;">1</td>
                            <td style="text-align: right;" class="price">R$ 9.900,00</td>
                            <td style="text-align: right;" class="price">R$ 9.900,00</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center;">32m × 14m <span class="discount-badge">80% DESC</span></td>
                            <td style="text-align: right;" class="price">R$ 2.400,00</td>
                        </tr>
                        <tr>
            ...
            <section class="section">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Gerador</td>
                            <td style="text-align: center;">80kVA</td>
                            <td style="text-align: right;" class="price">R$ 6.000,00*</td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="total-section">
            ...
            <div class="total-amount">R$ 76.580,00</div>
        </div>
    </div>
</body>
</html>